      ...
      <div className="min-h-screen flex items-center justify-center bg-[var(--background)]">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="text-center space-y-1">
            ...
            <p className="text-xs font-semibold tracking-widest text-[var(--muted-2)] uppercase">Teacher Portal</p>
          </div>
          ...
          <p className="text-xs text-[var(--muted)] animate-pulse">Loading teacher portal…</p>
        </div>
        <style>{`
